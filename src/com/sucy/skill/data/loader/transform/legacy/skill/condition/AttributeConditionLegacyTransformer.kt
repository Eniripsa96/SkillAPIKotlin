...
object AttributeConditionLegacyTransformer : LegacyEffectTransformer {
    override val defaultValues = emptyMap<String, Any>()
    override val conversions = listOf(
        LegacyConversion.Copy("attribute"),
        LegacyConversion.Scaling("min"),
        LegacyConversion.Scaling("max")
    )
}